...
// MarkerCoreRegex is the stable machine contract for the version-free v3 marker.
...
// shebang stays on line 1 and the marker becomes line 2 (as AddBanner does).
...
// comment wrapper to match kind (clobber-safety over recognition, as with banners).
